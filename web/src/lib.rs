...
const SITE_URL: &str = "https://stayhydated.github.io/gpui-es-fluent/";
const RUSTDOC_URL: &str = "https://docs.rs/gpui-es-fluent/";
const SOURCE_URL: &str = "https://github.com/stayhydated/gpui-es-fluent";
...
mod tests {
    ...
    fn embedded_demo_site_tracks_the_frame_and_static_gpui_demo() {
        ...
        assert_eq!(site.project().skill_command(), None);
        assert_eq!(
            route_manifest()
                .application_paths()
                .iter()
